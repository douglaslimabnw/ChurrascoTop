...
export function ResultsPanel({ result }: ResultsPanelProps) {
  ...
  const generateShareText = () => {
    let text = '🔥 *Lista de Churrasco* — boradechurras.online\n\n';
    ...
    text += '\n📲 Monte a sua lista em: boradechurras.online';
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-[#25D366] px-3 py-1.5 text-xs font-medium text-white shadow-sm transition-all duration-200 hover:bg-[#1da851] hover:shadow-md active:scale-95"
          >
